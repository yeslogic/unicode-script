...
//
//   yeslogic-ucd-generate script --rust-enum --name Script /home/wmoore/Downloads/ucd-14.0
//
...
pub const SCRIPT: &'static [(u32, u32, Script)] = &[
    ...
    (129656, 129660, Script::Common),
    (129664, 129670, Script::Common),
    (129680, 129708, Script::Common),
    (129712, 129722, Script::Common),
    (129728, 129733, Script::Common),
    (129744, 129753, Script::Common),
    (129760, 129767, Script::Common),
    (129776, 129782, Script::Common),
    (129792, 129938, Script::Common),
    (129940, 129994, Script::Common),
    (130032, 130041, Script::Common),
    (131072, 173791, Script::Han),
    (173824, 177976, Script::Han),
