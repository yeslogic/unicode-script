...
//
//   yeslogic-ucd-generate script --rust-enum --name Script /home/wmoore/Downloads/ucd-13.0
//
...
pub const SCRIPT: &'static [(u32, u32, Script)] = &[
    ...
    (42946, 42954, Script::Latin),
    (42997, 43007, Script::Latin),
    ...
    (129280, 129400, Script::Common),
    (129402, 129483, Script::Common),
    (129485, 129619, Script::Common),
    (129632, 129645, Script::Common),
    (129648, 129652, Script::Common),
    (129656, 129658, Script::Common),
    (129664, 129670, Script::Common),
    (129680, 129704, Script::Common),
    (129712, 129718, Script::Common),
    (129728, 129730, Script::Common),
    (129744, 129750, Script::Common),
    (129792, 129938, Script::Common),
    (129940, 129994, Script::Common),
    (130032, 130041, Script::Common),
    (131072, 173789, Script::Han),
